...
import {EventsEmitter, EventsEmitterComposer} from "../utils/events-emitter";
export class MultiModelExtensionBase extends EventsEmitterComposer(Autodesk.Viewing.Extension) {
