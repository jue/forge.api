...
export class Markup extends EventsEmitter {
  ...
  constructor(viewer, options = {}) {
    ...
    // this.update = Utils.throttle(this.update, 10);
  ...
  checkOcclusion(markup) {
    ...
    const offset = {left: this.viewer.container.offsetLeft, top: this.viewer.container.offsetTop};
